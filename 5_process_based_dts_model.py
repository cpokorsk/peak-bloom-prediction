...
OUTPUT_PREDICTIONS_FILE = os.path.join(
	MODEL_OUTPUT_DIR,
	f"final_{TARGET_YEAR}_dts_predictions.csv",
)
...
def main():
	...
	if bloom_train_df.empty:
		raise ValueError("No training rows left after last-2-years holdout split.")
	...
	print("\n3. Evaluating last-2-years holdout performance...")
