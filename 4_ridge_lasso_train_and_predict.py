...
def main():
    ...
    evaluate(ridge, x_val, y_val, "Ridge Validation")
    evaluate(ridge, x_test, y_test, "Ridge Main Test")
    evaluate(ridge, x_holdout, y_holdout, "Ridge Holdout")
    ...
    evaluate(lasso, x_val, y_val, "Lasso Validation")
    evaluate(lasso, x_test, y_test, "Lasso Main Test")
    evaluate(lasso, x_holdout, y_holdout, "Lasso Holdout")
